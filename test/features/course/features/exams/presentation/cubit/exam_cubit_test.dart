...
void main() {
  ...
  group('getExamQuestions', () {
    ...
    blocTest<ExamCubit, ExamState>(
      ...
      build: () {
        when(() => getExamQuestions(tExam)).thenAnswer((_) async => Left(tFailure));
        return cubit;
      },
      act: (cubit) => cubit.getExamQuestions(tExam),
      expect: () => [
  ...
  group('submitExam', () {
    ...
    blocTest<ExamCubit, ExamState>(
      ...
      build: () {
        when(() => submitExam(tUserExam)).thenAnswer((_) async => Left(tFailure));
        return cubit;
      },
      act: (cubit) => cubit.submitExam(tUserExam),
      expect: () => [
  ...
  group('getUserCourseExams', () {
    ...
    blocTest<ExamCubit, ExamState>(
      ...
      build: () {
        when(() => getUserCourseExams(tCourseId)).thenAnswer((_) async => Left(tFailure));
        return cubit;
      },
      act: (cubit) => cubit.getUserCourseExams(tCourseId),
      expect: () => [
