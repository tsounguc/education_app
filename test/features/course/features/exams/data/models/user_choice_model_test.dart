...
import 'package:education_app/features/course/features/exams/domain/entities/user_choice.dart';
...
void main() {
  ...
  group('UserChoiceModel', () {
    ...
    group('fromMap', () {
      test('should return a valid [UserChoiceModel] when the JSON is not null', () async {
    ...
    group('copyWith', () {
      test('should return a new [UserChoiceModel] with the same values', () async {
