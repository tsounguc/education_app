...
import 'package:education_app/features/course/features/exams/domain/entities/exam_question.dart';
import 'package:education_app/features/course/features/exams/domain/entities/question_choice.dart';
...
void main() {
  ...
  group('ExamQuestionModel', () {
    ...
    group('fromMap', () {
      test('should return a valid [ExamQuestionModel] when the JSON is not null', () async {
    ...
    group('fromUploadMap', () {
      test('should return a valid [ExamQuestionModel] when the JSON is not null', () async {
        final map = jsonDecode(fixture('uploaded_exam_question.json')) as DataMap;
    ...
    group('copyWith', () {
      test('should return a new [ExamQuestionModel] with the same values', () async {
