...
import 'package:education_app/features/notifications/data/models/notification_model.dart';
...
class MockNotificationRemoteDataSource extends Mock implements NotificationRemoteDataSrc {}
...
void main() {
  ...
  group('markAsRead', () {
    test(
      'should complete successfully when call to remote source is successful',
      () async {
        when(() => remoteDataSrc.markAsRead(any())).thenAnswer((_) async => const Right<dynamic, void>(null));
