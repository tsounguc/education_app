...
class ExamModel extends Exam {
  ...
  factory ExamModel.fromJson(String source) => ExamModel.fromUploadMap(jsonDecode(source) as DataMap);
  ...
  ExamModel.fromUploadMap(DataMap map)
      : this(
          ...
          imageUrl: (map['image_url'] as String).isEmpty ? null : map['image_url'] as String,
          questions:
              List<DataMap>.from(map['questions'] as List<dynamic>).map(ExamQuestionModel.fromUploadMap).toList(),
        );
