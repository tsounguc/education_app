...
import 'package:education_app/features/course/features/videos/data/models/video_model.dart';
...
class VideoRemoteDataSrcImpl implements VideoRemoteDataSrc {
  ...
  Future<void> addVideo(Video video) async {
    try {
      ...
      final videoRef = _firestore.collection('courses').doc(video.courseId).collection('videos').doc();
      ...
      if (videoModel.thumbnailIsFile) {
        ...
        await thumbnailFileRef.putFile(File(videoModel.thumbnail!)).then((value) async {
