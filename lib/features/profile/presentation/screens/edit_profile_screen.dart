...
import 'package:education_app/features/profile/presentation/widgets/edit_profile_form.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  bool get nothingChanged => !nameChanged && !emailChanged && !passwordChanged && !bioChanged && !imageChanged;
                    ...
                    child: state is AuthLoading
                        ...
                        : Text(
                            ...
                            style: TextStyle(
                              ...
                              color: nothingChanged ? Colors.grey : Colors.blueAccent,
                            ),
                          ),
                  );
                },
              ...
              children: [
                Builder(
                  builder: (context) {
                    ...
                    final userImage = user.profilePic == null || user.profilePic!.isEmpty ? null : user.profilePic;
                    return CircleAvatar(
                      radius: 50,
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          IconButton(
                            onPressed: pickImage,
                            icon: Icon(
                              (pickedImage != null || user.profilePic != null) ? Icons.edit : Icons.add_a_photo,
                              color: Colors.white,
                            ),
                          ),
                        ],
                ...
                const Padding(
                  ...
                  child: Text(
                    'wWe recommend an image of at least 400x400',
                    style: TextStyle(
                      fontSize: 14,
